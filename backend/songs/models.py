...
class Song(models.Model):
    ...
    album = models.ForeignKey(
        "Album", on_delete=models.CASCADE, related_name="songs", blank=True, null=True
    )
    popularity = models.IntegerField("Number of song plays", default=0)
    src = models.FileField("Song file", blank=True, null=True, upload_to="song_file")
...
class Album(models.Model):
    ...
    cover = models.ImageField(
        "Album cover", blank=True, null=True, upload_to="album_cover/"
    )
